...
const { getSupabase, checkEnv, signToken, ok, err, preflight, requireAuth, setCookieHeader } = require('./_utils');
  ...
  try {
    ...
    if (event.httpMethod === 'PUT' && action === 'profile') {
      ...
      const newToken = signToken({
        ...
        display_name: display_name.trim(), avatar_color: user.avatar_color,
      });
      return ok(
